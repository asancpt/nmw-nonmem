...
inputFirst <- read.csv("result/inputFirst.csv",
                       as.is = TRUE, row.names = TRUE)
input <- data.frame(t(inputFirst), stringsAsFactors = FALSE)

#NMDataset = Emax #Method = ZERO 
#nTheta = 2 #nEta = 1 #nEps = 1
#THETAinit = 10,100 #OMinit = 0.2 #SGinit = 1
...
```{r include = FALSE}
jpeg("result/xyplot.jpg", type = 'cairo')
